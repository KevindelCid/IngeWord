...
public class introduccion_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ArchivoExiste(archivos,"Intro.txt")){
            try {
                InputStreamReader archivo = new InputStreamReader(openFileInput("Intro.txt"));
    ...
    public void guardar(View view){
        try {
            OutputStreamWriter archivo = new OutputStreamWriter(
                    openFileOutput("Intro.txt", Activity.MODE_PRIVATE));
